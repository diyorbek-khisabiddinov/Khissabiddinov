...
pg.mixer.Sound(r"/Users/khissabiddinovdiyorbek/Desktop/PP2/Lab9/background.wav").play(-1)  # Play background sound in a loop
N = 3
...
backgraund = pg.image.load(r"/Users/khissabiddinovdiyorbek/Desktop/PP2/Lab9/way.jpg")
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"/Users/khissabiddinovdiyorbek/Desktop/PP2/Lab9/enemy.jpg")  # Load enemy image
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"/Users/khissabiddinovdiyorbek/Desktop/PP2/Lab9/car.jpg")  # Load player image
...
while running:
    ...
    if pg.sprite.spritecollideany(P, enemies):
        pg.mixer.Sound(r"/Users/khissabiddinovdiyorbek/Desktop/PP2/Lab9/crash.wav").play()  # Play crash sound
